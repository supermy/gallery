...
class ResetPwdPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const ResetPwdFormField(),
    );
  }
}

class ResetPwdFormField extends StatefulWidget {
  const ResetPwdFormField({super.key});

  @override
  ResetPwdFormFieldState createState() => ResetPwdFormFieldState();
}

class ResetPwdPersonData {
  String? name = '';
  String? phoneNumber = '';
  String? email = '';
  String password = '';
...
class _ResetPasswordFieldState extends State<ResetPasswordField> with RestorationMixin {
...
class ResetPwdFormFieldState extends State<ResetPwdFormField>
    with RestorationMixin {
  ResetPwdPersonData person = ResetPwdPersonData();

  late FocusNode _phoneNumber, _email, _lifeStory, _password, _retypePassword,_oldPassword;
...
// ScaffoldMessenger是一个小部件，提供了在屏幕顶部和底部显示snackBar和material banner的API。
  ...
  final GlobalKey<FormFieldState<String>> _oldpasswordFieldKey =
  GlobalKey<FormFieldState<String>>();
  ...
  void _handleSubmitted() {
    ...
    if (!form.validate()) {
      ...
      print(person.oldpassword);
      showInSnackBar(GalleryLocalizations.of(context)!
          .demoMyLoginEMailAndPwd(person.oldpassword!, person.password!));
    }
  }
  ...
  String? _validateOldPasswordEmpty(String? value) {

    final passwordField = _oldpasswordFieldKey.currentState!;
    final phoneExp = RegExp(r"^[a-zA-Z][a-zA-Z0-9_]{4,18}$");
    if (!phoneExp.hasMatch(passwordField.value!)) {
      return GalleryLocalizations.of(context)!.demoPWDFieldNoMoreThan;
    }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              // ),
              // TextFormField(
              //   restorationId: 'old_password_field',
              ...
              ResetPasswordField(
                ...
                labelText: localizations.demoTextFieldOldPassword,
                validator: _validateOldPasswordEmpty,
                onSaved: (value) {
                  person.oldpassword = value!;
                },
                onFieldSubmitted: (value) {
              ...
              ResetPasswordField(
                ...
                helperText: localizations.demoPWDFieldNoMoreThan,
                labelText: localizations.demoTextFieldNewPassword,
                validator: _validatePasswordEmpty,
                onSaved: (value) {
              ...
              Center(
                child: ElevatedButton(
                  ...
                  child: Text(localizations.resetPwd),
                ),
              ),
              sizedBoxSpace,
              Text(
